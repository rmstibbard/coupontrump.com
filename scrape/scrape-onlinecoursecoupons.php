...
$page_title = "Scrape Online Course Coupons";
...
$site = "www.onlinecoursecoupons.com";

$endings = array ("/recently-added-courses/");
...
foreach ($endings as $ending ) {
    ...
    for ($i=$from; $i<=$to; $i++) {
        ...
        $results_page = scrape_between($results_page, '<div class="wf-container-main">', '<div id="bottom-bar"');
        
        $separate_results = explode('gv-field-1-custom', $results_page);
        
        foreach ($separate_results as $separate_result) {
            
            if ($separate_result != "") {
            
                $base_url = trim(scrape_between($separate_result, '/coursecoupon/', '/">'));
                
                if ($base_url!="") {
                    
                    $link_url = "http://onlinecoursecoupons.com/coursecoupon/" . $base_url;
